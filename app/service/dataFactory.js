            ...
            return {
                ...
                getDataDetall: (codeParam) => {
                    ...
                    const dataDetall = {
                        ...
                        'react': {
                            'paragrafs': [
                                {"htmlText": "<cite>React</cite> és una llibreria de Javascript de codi obert per a la construcció amb facilitat d'interfícies d'usuari interactives. Es fa el disseny de vistes simples per a cada estat de l'aplicació, i <cite>React</cite> actualitza i renderitza eficientment només aquells components quan les dades canvien. Les seves vistes declaratives fan que el seu codi sigui més predictible i fàcil de depurar. Permet la creació de components encapsulats que administren el seu propi estat, i posteriorment, compondre'ls per crear intefícies d'usuari complexes. Ja que la lògica dels components està escrita amb Javascript en lloc de amb plantilles, permet el pas de dades enriquides a través de l'aplicació i així mantenir l'estat fora del <abbr title='Document Object Model' lang='en'>DOM</abbr>. A més permet el renderitzat al servidor utilitzant <cite>Node</cite> i la creació aplicacions per a mòbils amb <span lang='en'><cite>React Native</cite></span>"},
                                {"htmlText": "Els components de React implemenen un mètode anomenta <span lang='en'>render</span>() que rep dades d'entrada i retorna el que s'ha de mostrar. Es pot accedir a les dades d'entrada que es passen al component mitjançant <span lang='en'>render</span>() a través de this.props. A més d'obtenir dades d'entrada un component pot tenir dades en el seu estat intern (als qual s'accedeix amb this.state). Quan les dades de l'estat d'un component cambien, es torna a invocar <span lang='en'>render</span> amb els nous valors de l'estat. El cicle de vida dels estats es pot dividir en tres etapes inicialització, actualització i destrucció. <cite>React</cite> permet la interacció amb altres biblioteques i marcs de treball."},
                                {"htmlText": "<cite>React</cite> manté un <abbr title='Document Object Model' lang='en'>DOM</abbr> virtual propi, en lloc de confiar solament en el del navegador. Això deixa a la biblioteca determinar quines parts del <abbr title='Document Object Model' lang='en'>DOM</abbr> han canviat comparant continguts entre la versió nova i la que te desada virtualment, i utilitzar el resultat per determinar com actualitzar eficientment el <abbr title='Document Object Model' lang='en'>DOM</abbr> del navegador. React utilitza un sintaxi pareguda a <abbr title='Hypertext Markup Language' lang='en'>HTML</abbr>, anomenada JSX. No és necessària per poder utilitzar <cite>React</cite>, però, fa el codi més llegible i escriure'l és una experiència similar a fer-ho amb <abbr title='Hypertext Markup Language' lang='en'>HTML</abbr>."}
                            ],
                            'altImg': 'Logo React',
                        ...
                        'vue': {
                            'paragrafs': [
                                {"htmlText": "<cite>Vue</cite> és un marc de treball progressiu per a construir interfícies d'usuari. A deferència d'altres <span lang='en'>frameworks</span> monolítics <cite>Vue</cite> està dissenyat des de zero per a ser gradualment adoptable. La biblioteca principal es centra només en la capa de la vista i és fàcil de recollir i integrar amb altres biblioteques o projectes existents. D'altra banda, <cite>Vue</cite> també és perfectament capaç d'implementar <abbr title='Single Page Applications' lang='en'>SPAs</abbr> sofisticades quan s'utilitza en combinació amb altres eines i biblioteques modernes de suport."},
                                {"htmlText": "<cite>Vue.js</cite> utilitza una sintaxi de plantilles basades en <abbr title='Hypertext Markup Language' lang='en'>HTML</abbr> que li permet vincular declarativament el <abbr title='Document Object Model' lang='en'>DOM</abbr> renderitzat a les dades subjacents de la instància de <cite>Vue</cite>. Totes les plantilles de <cite>Vue.js</cite> són plantilles ,<abbr title='Hypertext Markup Language' lang='en'>HTML</abbr> vàlides, que poden ser processades per navegadors i analitzadors d'<abbr title='Hypertext Markup Language' lang='en'>HTML</abbr> per validar que compleixin amb les especificacions. Internament, <cite>Vue</cite> compila les plantilles en funcions de renderització virtual del <abbr title='Document Object Model' lang='en'>DOM</abbr>. En combinació amb el sistema de reactivitat, <cite>Vue</cite> és capaç de calcular de forma intel·ligent la quantitat mínima de components per tornar a renderitzar i aplicar la quantitat mínima de manipulacions del <abbr title='Document Object Model' lang='en'>DOM</abbr> quan canvia l'estat de l'aplicació."},
                                {"htmlText": "<cite>Vue</cite> proporciona una interfície per canviar el que es mostra a lapàgina den funció de la ruta de <abbr title='Uniform Resource Identifier' lang='en'>URL</abbr> actual, independentment de com s'hagi modificat. A més, l'ús d'un enrutador frontal permet la transició intencional de la ruta del navegador quan succeeixen certs events del navegador en botons o enllaços. <cite>Vue</cite> en si mateix, no ve amb un enrutament <span>hash front-end</span>. Però el paquet de codi obert <cite>vue-router</cite> proporciona una <abbr title='Application Programming Language' lang='en'>API</abbr> per actualitzar la <abbr title='Uniform Resource Identifier' lang='en'>URL</abbr> de l'aplicació, admet el botó enrere del navegador i reestableix la contrassenya del correu o enllaços de verificació de correu amb paràmetres d'autenticació <abbr title='Uniform Resource Identifier' lang='en'>URL</abbr>. També admet l'assignació de rutes niades a components niats i ofereix un control de transició detallat."}
                            ],
                            'altImg': 'Logo Vue',
